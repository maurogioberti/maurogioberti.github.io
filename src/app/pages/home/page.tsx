      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-vs-background text-vs-foreground font-sans p-10">
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-lg font-semibold">
            <Link
              href="https://github.com/maurogioberti/website" className="text-blue-500 underline hover:text-blue-700 transition-colors duration-200 flex items-center justify-center" aria-label="Discover the source code of this website on GitHub">
