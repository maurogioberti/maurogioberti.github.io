...
export default async function HomePage() {
  ...
  return (
    <>
        <div className="min-h-screen flex flex-col items-center justify-center bg-vs-background text-vs-foreground font-sans px-6 py-16 sm:px-10 sm:py-20">
        ...
        <div className="mt-6 text-lg text-center">
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-center sm:justify-center space-y-2 sm:space-y-0 sm:space-x-4">
            ...
            <Link href={`${profile.linkedinUrl}`} className="btn-secondary text-center">
              Let&apos;s Connect
            </Link>
          </div>
        </div>
        <div className="mt-8 text-center">
          ...
          <p className="text-lg text-vs-foreground/70 text-sm">Dive into the source straight from the heart of my code!</p>
          <p className="text-lg font-semibold">
            <Link
              href="https://github.com/maurogioberti/maurogioberti.github.io" className="text-vs-primary underline hover:text-vs-primary-light transition-colors duration-200 flex items-center justify-center" aria-label="Discover the source code of this website on GitHub">
